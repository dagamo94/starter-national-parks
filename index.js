const submitHandler = (event) => {
  ...
  if(!Object.keys(errors).length){
    ...
    // Clear form values once they have been submitted
    const inputTags = document.querySelectorAll("input");
    inputTags.forEach(el => el.value = "");
...
function validateExists(value) {
  return value && value.trim(); // boolean statement to check if 'value' is more than one non-space character
}
